...
if __name__ == "__main__":
    ...
    for experiment in experiment_data:
        ...
        filter_vals = mmtb.evaluation.filters.blind_filter(t_sample=experiment.spec_settings.t_sample,
        ...
        # filter_vals = mmtb.evaluation.filters.smoothed_filter(t_sample=experiment.spec_settings.t_sample,
        #                                                       t_symbol=experiment.trans_param.t_symbol,
        #                                                       t_irradiation=experiment.trans_param.t_irradiation,
        ...
        synchronization = mmtb.evaluation.synchronization.CorrelationSynchronization(t_sample=experiment.spec_settings.t_sample,
                                                                                     t_symbol=experiment.trans_param.t_symbol,
