[mmtb](../../../README.md)/[evaluation](../../evaluation.md)/[filters](../filters.md)/smoothed_filter

## mmtb.evaluation.filters.smoothed_filter

**def** $\color{mediumpurple}smoothed\_ filter$ (t_sample: float, t_symbol: float, t_irradiation: float, dis_tx_rx: float, fraction_used_data: float = 0.2) &rarr; `np.array`
