...
**class** $\color{purple}SynchronizationBase$ (t_sample: float,
...
+ **@abstractmethod** $\color{mediumpurple}\_ eval\_ func$ (sample_values: Sequence[float]) -> `float`
...
+ **@abstractmethod** $\color{mediumpurple}\_ aggregation\_ func$ (sample_values: Sequence[float]) -> `int`
