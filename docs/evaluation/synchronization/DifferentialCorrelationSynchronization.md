[mmtb](../../../README.md)/[evaluation](../..//evaluation.md)/[synchronization](../synchronization.md)/DifferentialCorrelationSynchronization

## mmtb.types.synchronization.DifferentialCorrelationSynchronization

**class** $\color{purple}DifferentialCorrelationSynchronization$ (t_sample: float,
...
+  $\color{mediumpurple}set\_ transmission\_ start$ (transmission_start_time: float) -> `None`
    ...
    Sets the transmission start time, after which the synchronization process will begin. No synchronization can take place before this method is called.W